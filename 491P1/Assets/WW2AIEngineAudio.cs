...
public class WW2AIEngineAudio : MonoBehaviour {
	/* 
 ...
 */
		...
		void Awake(){
		    AkSoundEngine.PostEvent ("startWW2Engine", this.gameObject);
	...
	void OnDestroy(){
		AkSoundEngine.PostEvent ("stopWW2Engine", gameObject);
	}
		...
		void FixedUpdate () {
			...
			AkSoundEngine.SetRTPCValue ("classicDoppler", dopplerPitch, gameObject); // "DopplerParam" is the name of the RTPC in the Wwise project :)
