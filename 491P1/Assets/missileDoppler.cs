...
public class missileDoppler : MonoBehaviour {
	...
	void FixedUpdate () {
        ...
        if (playerF)
        {
            ...
            AkSoundEngine.SetRTPCValue("missileDoppler", dopplerPitch, gameObject); // "DopplerParam" is the name of the RTPC in the Wwise project :)
