 ...
 */
    ...
    void Awake()
    {
        AkSoundEngine.PostEvent("startLaserLoop", this.gameObject);
    ...
    void OnDestroy()
    {
        AkSoundEngine.PostEvent("stopLaserLoop", gameObject);
    }
    ...
    void FixedUpdate()
    {
        ...
        AkSoundEngine.SetRTPCValue("Lasers", dopplerPitch, gameObject); // "DopplerParam" is the name of the RTPC in the Wwise project :)
